...
```bash
docker build -f bdw/Dockerfile -t bit-data-workbench:0.10.33 .
```
...
```text
docker-hub.nexus.bit.admin.ch/svabra/bit-data-workbench:0.10.33
```
