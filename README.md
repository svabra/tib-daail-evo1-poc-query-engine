...
- `s3.*` for S3-backed startup views
...
```bash
docker build -f bdw/Dockerfile -t bit-data-workbench:0.10.24 .
```
...
```text
docker-hub.nexus.bit.admin.ch/svabra/bit-data-workbench:0.10.24
```
