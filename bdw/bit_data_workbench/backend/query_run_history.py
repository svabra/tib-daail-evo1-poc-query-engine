...
def _compact_query_job_payload(job: dict[str, Any]) -> dict[str, Any]:
    metrics = {
        ...
        "cpuCapacityPercent": job.get("cpuCapacityPercent"),
        "averageCpuCapacityPercent": job.get("averageCpuCapacityPercent"),
        "peakCpuCapacityPercent": job.get("peakCpuCapacityPercent"),
        "cpuCapacityCores": job.get("cpuCapacityCores"),
