...
class NotebookEditorUiRegressionTests(unittest.TestCase):
    ...
    def test_notebook_stage_pipeline_has_mode_graph_table_and_actions(self) -> None:
        ...
        self.assertIn("animation: pipeline-node-computing-glow 1.5s ease-in-out infinite;", css_source)
        ...
        self.assertIn("animation: pipeline-stage-row-computing-glow 1.5s ease-in-out infinite;", css_source)
